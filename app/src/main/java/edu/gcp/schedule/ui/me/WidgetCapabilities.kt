...
import edu.gcp.schedule.ui.widget.ScheduleWidgetReceiver
...
internal object WidgetCapabilities {
     ...
     */
    const val manualAddHint: String = "当前桌面不支持一键添加，请长按桌面空白处 → 小组件 → 城职课表"
 ...
 * [edu.gcp.schedule.ui.widget.widgetMetricsFor] 分档，保证预览与桌面所见一致。
 */
