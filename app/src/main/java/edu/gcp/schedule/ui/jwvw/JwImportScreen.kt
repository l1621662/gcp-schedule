package edu.gcp.schedule.ui.jwvw
...
import edu.gcp.schedule.BuildConfig
import edu.gcp.schedule.Graph
import edu.gcp.schedule.data.jw.ExamScheduleParser
import edu.gcp.schedule.data.jw.ImportParseResult
import edu.gcp.schedule.data.jw.JwImportDiagnosis
import edu.gcp.schedule.data.jw.JwSchedulePage
import edu.gcp.schedule.data.jw.JwUrls
import edu.gcp.schedule.data.jw.JwVpnDetector
import edu.gcp.schedule.data.jw.ZhengfangScheduleParser
import edu.gcp.schedule.data.jw.ZhengfangScoreParser
import edu.gcp.schedule.data.jw.unwrapJsString
...
import edu.gcp.schedule.ui.common.ImportTargetDialogHost
import edu.gcp.schedule.ui.common.resolveImportTarget
...
fun JwImportScreen(
    ...
    var pendingScores by remember { mutableStateOf<List<Pair<String, List<edu.gcp.schedule.domain.ScoreRecord>>>?>(null) }
